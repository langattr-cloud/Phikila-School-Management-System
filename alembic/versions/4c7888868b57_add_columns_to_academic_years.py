...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'ARCHIVED', name='statusenum'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.add_column('academic_years', sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'ARCHIVED', name='statusenum'), nullable=True))
    ...
    op.add_column('levels', sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'ARCHIVED', name='statusenum'), nullable=True))
    ...
    op.add_column('streams', sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'ARCHIVED', name='statusenum'), nullable=True))
