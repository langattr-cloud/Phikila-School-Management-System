                ...
                <div className="card section">
                  ...
                  {readOnly ? (
                    ...
                    <>
                      ...
                      <div className="field field--inline">
                        <label className="field__label" htmlFor="edit-day">Day</label>
                        <select
                          id="edit-day"
                          className="input input--select"
                      ...
                      <div className="field field--inline">
                        <label className="field__label" htmlFor="edit-period">Period</label>
                        <select
                          id="edit-period"
                          className="input input--select"
                      ...
                      <div className="field field--inline">
                        <label className="field__label" htmlFor="edit-duration">Duration</label>
                        <select
                          id="edit-duration"
                          className="input input--select"
                      ...
                      <div className="field field--inline">
                        <label className="field__label" htmlFor="edit-teacher">Teacher</label>
                        <select
                          id="edit-teacher"
                          className="input input--select"
                      ...
                      <div className="field field--inline">
                        <label className="field__label" htmlFor="edit-room">Room</label>
                        <select
                          id="edit-room"
                          className="input input--select"
