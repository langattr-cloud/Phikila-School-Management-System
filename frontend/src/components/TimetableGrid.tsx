      ...
      {showPrintPreview && (
        <div className="timetable-print-preview" role="dialog" aria-modal="true" aria-label="Timetable print preview">
          <style>{`
            ...
            .print-table__corner,.print-table__period,.print-table__day,.print-table__cell{border-right:1px solid #111827;border-bottom:1px solid #111827;box-sizing:border-box}.print-table__break-cell{border-bottom:0!important;background:#fff!important}.print-table__corner,.print-table__period{background:#1e293b;color:#fff;text-align:center;min-height:42px;padding:4px 2px}.print-table__period{display:flex;flex-direction:column;justify-content:center;font-size:9px}.print-table__period span{font-size:6px;font-weight:400}.print-table__break{background:#64748b!important}.print-table__row{display:contents}.print-table__day{background:#e2e8f0;font-size:9px;font-weight:800;padding:5px;display:flex;align-items:center}.print-table__cell{min-height:42px;padding:4px;text-align:center;display:flex;flex-direction:column;justify-content:center;overflow:hidden}.print-table__break-cell{min-height:42px}.print-table__cell strong{font-size:10px;line-height:1.05}.print-table__cell small{font-size:7px;line-height:1.1;margin-top:2px}.print-table__break-cell{background:#fff!important;border-bottom:0!important}.print-table--dense .print-table__cell{min-height:30px;padding:2px}.print-table--dense .print-table__cell small{display:none}
            .summary-grid{display:grid;grid-template-columns:70px repeat(var(--summary-cols),minmax(34px,1fr));border-top:1px solid #111827;border-left:1px solid #111827;--summary-cols:${Math.max(1, activeDays.length * displayPeriods.length)}}.summary-grid__corner,.summary-grid__head,.summary-grid__label,.summary-grid__cell{border-right:1px solid #111827;border-bottom:1px solid #111827;box-sizing:border-box}.summary-grid__break-cell{border-bottom:0!important;background:#fff!important}.summary-grid__corner,.summary-grid__head{background:#1e293b;color:#fff;font-size:7px;font-weight:800;text-align:center;padding:4px 2px}.summary-grid__label{background:#e2e8f0;font-size:8px;font-weight:800;padding:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.summary-grid__break-head{background:#64748b!important}.summary-grid__break-cell{background:#fff!important;border-bottom:0!important}.summary-grid__cell{height:24px;font-size:7px;font-weight:800;text-align:center;padding:3px;display:flex;align-items:center;justify-content:center;overflow:hidden}
