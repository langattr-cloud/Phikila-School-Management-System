...
export function TimetableMainToolbar() {
  ...
  return <div className="timetable-main-toolbar" role="toolbar" aria-label="Timetable main toolbar">
    ...
    <style>{`\n      .timetable-main-toolbar{display:flex;align-items:stretch;width:100%;min-height:72px;background:#F0F0F0;border:1px solid #d1d1d1;border-radius:4px;box-shadow:inset 0 1px #fff;overflow-x:auto;margin:0 0 14px;padding:0 4px;}\n      .timetable-main-toolbar__item{display:flex;flex:0 0 82px;flex-direction:column;align-items:center;justify-content:center;gap:5px;border:0;background:transparent;color:#222;text-decoration:none;font:500 12px/1.1 Arial,Helvetica,sans-serif;cursor:pointer;padding:7px 6px;}\n      .timetable-main-toolbar__item:hover{background:#e4e4e4;}\n      .timetable-main-toolbar__item:focus-visible{outline:2px solid #2563eb;outline-offset:-2px;}\n      .timetable-main-toolbar__icon{display:flex;width:24px;height:24px;align-items:center;justify-content:center;}\n      .timetable-main-toolbar__separator{width:1px;height:50px;align-self:center;background:#c8c8c8;box-shadow:1px 0 #fff;flex:0 0 1px;}\n      .timetable-main-toolbar__setup{display:flex;flex:0 0 92px;align-items:stretch;justify-content:center;position:relative;}\n      .timetable-main-toolbar__setup>.button{border:0!important;background:transparent!important;box-shadow:none!important;border-radius:0!important;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;padding:7px 5px;width:92px;color:#222;font:500 12px/1.1 Arial,Helvetica,sans-serif;position:relative;}\n      .timetable-main-toolbar__setup>.button:before{content:'🖨';font-size:22px;line-height:22px;height:24px;display:block;filter:grayscale(1);}\n      .timetable-main-toolbar__setup>.button:after{content:'⚙';position:absolute;top:25px;left:calc(50% + 7px);font-size:11px;line-height:11px;color:#333;}\n      .timetable-main-toolbar__setup>.button:hover{background:#e4e4e4!important;}\n      @media(max-width:700px){.timetable-main-toolbar__item{flex-basis:72px}.timetable-main-toolbar__setup,.timetable-main-toolbar__setup>.button{flex-basis:82px;width:82px}}\n    `}</style>\n  </div>\n}\n