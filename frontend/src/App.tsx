...
const AcademicSetupWizardPage = lazy(() => import('./pages/AcademicSetupWizardPage').then(m => ({ default: m.default })))
const RequirementsPage = lazy(() => import('./pages/RequirementsPage').then(m => ({ default: m.default })))
const ConstraintsPage = lazy(() => import('./pages/ConstraintsPage').then(m => ({ default: m.default })))
const TimeOffPage = lazy(() => import('./pages/TimeOffPage').then(m => ({ default: m.default })))
const GeneratePage = lazy(() => import('./pages/GeneratePage').then(m => ({ default: m.default })))
const CopilotPage = lazy(() => import('./pages/CopilotPage').then(m => ({ default: m.default })))
...
const ExaminationLevelsPage = lazy(() => import('./pages/ExaminationLevelsPage').then(m => ({ default: m.default })))
...
const SchedulingAnalyticsPage = lazy(() => import('./pages/SchedulingAnalyticsPage').then(m => ({ default: m.default })))
const VersionsPage = lazy(() => import('./pages/VersionsPage').then(m => ({ default: m.default })))
...
const PlatformDashboardPage = lazy(() => import('./pages/PlatformPage').then(m => ({ default: m.default })))
const PlatformSchoolsPage = lazy(() => import('./pages/PlatformPage').then(m => ({ default: m.default })))
const PlatformSchoolDetailPage = lazy(() => import('./pages/PlatformPage').then(m => ({ default: m.default })))
const PlatformRequestsPage = lazy(() => import('./pages/PlatformPage').then(m => ({ default: m.default })))
const PlatformAdminsPage = lazy(() => import('./pages/PlatformPage').then(m => ({ default: m.default })))
const PlatformAuditPage = lazy(() => import('./pages/PlatformAuditPage').then(m => ({ default: m.default })))
const AwaitingApprovalPage = lazy(() => import('./pages/AwaitingApprovalPage').then(m => ({ default: m.default })))
