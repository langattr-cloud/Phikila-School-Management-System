...
function normalizeStudentList(value: StudentListResponse | Student[], params?: { page?: number; page_size?: number; search?: string; status?: string; academic_year_id?: number; level_id?: number; grade_id?: number; stream_id?: number }): StudentListResponse {
...
export const students = {
  list: async (params?: { page?: number; page_size?: number; search?: string; status?: string; academic_year_id?: number; level_id?: number; grade_id?: number; stream_id?: number }) => {
  ...
  create: (payload: Record<string, unknown>) => send<Student>(`${BASE}/students`, 'POST', payload),
  update: (id: number, payload: Record<string, unknown>) => send<Student>(`${BASE}/students/${id}`, 'PATCH', payload),
