...
/** Keeps the UI compatible with the canonical paginated API and older Worker array responses. */
...
export const students = {
  list: async (params?: { page?: number; page_size?: number; search?: string; status?: string; class_id?: number; level_id?: number; stream_id?: number }) => {
