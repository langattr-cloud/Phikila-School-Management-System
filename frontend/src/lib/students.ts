...
export interface Enrollment { id: number; school_id: number; student_id: number; academic_year_id: number; term_id?: number | null; level_id: number; class_id?: number | null; grade_id?: number | null; stream_id?: number | null; status: string; enrollment_date?: string; created_at?: string }
...
export const students = {
  list: (params?: { page?: number; page_size?: number; search?: string; status?: string; academic_year_id?: number; level_id?: number; class_id?: number; grade_id?: number; stream_id?: number }) => {
