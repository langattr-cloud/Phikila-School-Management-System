...
export interface PrintProfile { id: number; name: string; config: Loose; is_default: boolean; created_by?: string | null; created_at: string; updated_at?: string | null }
export interface PrintProfileInput { name: string; config: Loose; is_default?: boolean }
...
export const scheduling = {
 ...
 printProfiles:()=>get<PrintProfile[]>('/print-profiles'), createPrintProfile:(p:PrintProfileInput)=>send<PrintProfile>('/print-profiles','POST',p), updatePrintProfile:(id:number,p:PrintProfileInput)=>send<PrintProfile>(`/print-profiles/${id}`,'PUT',p), deletePrintProfile:(id:number)=>send<void>(`/print-profiles/${id}`,'DELETE'),
