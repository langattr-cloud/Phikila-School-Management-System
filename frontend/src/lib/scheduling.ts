...
export const scheduling = {
 ...
 requirements:()=>get<Requirement[]>('/requirements'), createRequirement:(p:RequirementInput)=>send<Requirement>('/requirements','POST',p), deleteRequirement:(id:number)=>send<void>(`/requirements/${id}`,'DELETE'), constraints:()=>get<Constraint[]>('/constraints'), createConstraint:(p:ConstraintInput)=>send<Constraint>('/constraints','POST',p), updateConstraint:(id:number,p:ConstraintInput)=>send<Constraint>(`/constraints/${id}`,'PUT',p), deleteConstraint:(id:number)=>send<void>(`/constraints/${id}`,'DELETE'),
