...
export interface SchoolClass extends Loose { id: number; name: string; code?: string; grade?: string | null; student_count?: number; home_room_id?: number | null; class_teacher_id?: number | null; unavailable?: Slots }
export interface SchoolClassInput { name: string; code: string; grade: string | null; student_count: number; home_room_id: number | null; class_teacher_id: number | null; unavailable: Slots }
