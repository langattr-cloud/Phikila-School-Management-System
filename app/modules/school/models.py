...
class SchoolSettings(Base):
    ...
    key = Column(String(100), nullable=False, default="school_settings")
...
class SchoolBranding(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    school_id = Column(Integer, ForeignKey("school_info.id", ondelete="CASCADE"), unique=True, nullable=False)
    logo_path = Column(String(255), nullable=True); stamp_path = Column(String(255), nullable=True); report_header = Column(Text, nullable=True); report_footer = Column(Text, nullable=True)
    primary_color = Column(String(50), nullable=True); secondary_color = Column(String(50), nullable=True)
...
class SchoolContact(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    school_id = Column(Integer, ForeignKey("school_info.id", ondelete="CASCADE"), unique=True, nullable=False)
    principal = Column(String(255), nullable=True); deputy_principal = Column(String(255), nullable=True); bursar = Column(String(255), nullable=True); telephone = Column(String(50), nullable=True); mobile = Column(String(50), nullable=True); email = Column(String(255), nullable=True); emergency_contact = Column(String(50), nullable=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False); updated_at = Column(DateTime(timezone=True), server_default=func.now(), onupdate=func.now(), nullable=False)
