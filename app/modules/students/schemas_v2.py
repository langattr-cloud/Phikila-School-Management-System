...
class GuardianCreate(BaseModel):
    full_name:str=Field(min_length=1,max_length=200);relationship:str=Field(min_length=1,max_length=50);phone:str=Field(min_length=5,max_length=30);alt_phone:str|None=None;email:str|None=None;address:str|None=None;occupation:str|None=None;is_emergency_contact:bool=False
...
class StudentCreate(BaseModel):
    admission_number:str=Field(min_length=1,max_length=50);first_name:str=Field(min_length=1,max_length=100);middle_name:str|None=None;last_name:str=Field(min_length=1,max_length=100);preferred_name:str|None=None;date_of_birth:date|None=None;gender:str|None=None;email:str|None=None;phone:str|None=None;address:str|None=None;nationality:str="Kenyan";national_id:str|None=None;photo_url:str|None=None;admission_date:date|None=None
...
class EnrollmentResponse(BaseModel):
    id:int;school_id:int;student_id:int;academic_year_id:int;term_id:int|None=None;level_id:int;class_id:int|None=None;school_class_id:int|None=None;grade_id:int|None=None;stream_id:int|None=None;status:str;enrollment_date:date|None=None;created_at:datetime|None=None
    model_config={"from_attributes":True}
