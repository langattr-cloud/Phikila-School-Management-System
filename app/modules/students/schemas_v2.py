...
class EnrollmentResponse(BaseModel):
    id:int; school_id:int; student_id:int; academic_year_id:int; term_id:int|None=None; level_id:int; grade_id:int; stream_id:int; status:str; enrollment_date:date|None=None; created_at:datetime|None=None
    model_config={"from_attributes":True}
