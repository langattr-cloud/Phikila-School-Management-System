...
def _config(db,school_id,payload):
    ...
    return {'label':payload.label,'timetable_type_id':payload.timetable_type_id,'display_mode':mode,'day_indexes':day_indexes,'day_names':day_names,'class_ids':payload.class_ids,'teacher_ids':payload.teacher_ids,'period_indexes':payload.period_indexes}
