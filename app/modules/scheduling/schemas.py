...
class TeacherIn(BaseModel): name:str=Field(min_length=1,max_length=120);code:str=Field(min_length=1,max_length=30);email:str|None=None;department:str|None=None;max_lessons_per_day:int=Field(default=7,ge=1,le=20);max_consecutive:int=Field(default=4,ge=1,le=20);workload_target:int|None=Field(default=None,ge=0,le=80);unavailable:Slots=Field(default_factory=dict);is_active:bool=True
class TeacherOut(ORMModel,TeacherIn): id:int
class SubjectIn(BaseModel): name:str=Field(min_length=1,max_length=120);code:str=Field(min_length=1,max_length=30);colour:str=Field(default='#0F2A47',max_length=9);prefers_morning:bool=False;prefers_double:bool=False;spread_across_week:bool=True;required_room_type:str|None=None
class SubjectOut(ORMModel,SubjectIn): id:int
class RoomIn(BaseModel): name:str=Field(min_length=1,max_length=120);code:str=Field(min_length=1,max_length=30);building:str|None=None;capacity:int=Field(default=40,ge=1,le=2000);room_type:str=Field(default='classroom',max_length=40);is_accessible:bool=True;unavailable:Slots=Field(default_factory=dict)
class RoomOut(ORMModel,RoomIn): id:int
class ClassIn(BaseModel): name:str=Field(min_length=1,max_length=120);code:str=Field(min_length=1,max_length=30);grade:str|None=None;student_count:int=Field(default=40,ge=1,le=500);home_room_id:int|None=None;unavailable:Slots=Field(default_factory=dict)
