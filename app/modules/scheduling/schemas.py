...
class PeriodIn(BaseModel): index:int=Field(ge=0,le=30); name:str=Field(min_length=1,max_length=40); short_form:str=Field(default='',max_length=20); start_time:str=Field(pattern=r'^\d{2}:\d{2}$'); end_time:str=Field(pattern=r'^\d{2}:\d{2}$'); is_teaching:bool=True
...
class DayIn(BaseModel): index:int=Field(ge=0,le=30); name:str=Field(min_length=1,max_length=80); short_form:str=Field(default='',max_length=20); date_value:str|None=Field(default=None,max_length=40); is_active:bool=True
...
class TimetableTypeIn(BaseModel): name:str=Field(min_length=1,max_length=120); code:str=Field(min_length=1,max_length=40); display_mode:Literal['day','date']='day'; day_indexes:list[int]=Field(min_length=1,max_length=31); is_active:bool=True; is_system:bool=False
