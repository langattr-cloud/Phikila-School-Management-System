...
class ConstraintUpdate(BaseModel): kind: str | None = Field(default=None, min_length=1, max_length=60); scope: Literal['school','teacher','class','subject','room'] | None = None; target_id: int | None = None; is_hard: bool | None = None; weight: int | None = Field(default=None, ge=0, le=100); params: dict[str,Any] | None = None; enabled: bool | None = None; note: str | None = None
