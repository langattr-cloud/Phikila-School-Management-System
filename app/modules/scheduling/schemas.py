...
class ClassOut(ORMModel,ClassIn): id:int; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None
