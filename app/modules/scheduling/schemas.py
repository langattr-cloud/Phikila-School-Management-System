...
class ClassUpdateIn(BaseModel):
    ...
    def normalize_frontend_values(cls, value):
        ...
        return data
class ClassOut(ORMModel,ClassIn): id:int; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None; academic_stream:str|None=None
